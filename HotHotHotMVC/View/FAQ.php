...
<h2>Framework</h2>
    <h3>Modele View Controller</h3>
        <p>Ce framework PHP s'articule en MVC, ce qui signifie qu'il possède les dossiers suivants:</p>
            <ul>
                <li>Modele: contient les données que l'on souhaite afficher. </li>
                <li>View: contient l'interface graphique. </li>
                <li>Controller: permet de modifier les données du modèle et de la vue et traite les actions effectuées par l'utilisateur. </li>
            </ul>
    <h3>Autres dossiers importants</h3>
        <p>Ce Framework contient également d'autres dossiers permettant de le faire fonctionner: </p>
            <ul>
                <li>Core: c'est le noyau qui permet de charger les différentes pages de ce Framework. </li>
                <li>Buffer: comprend les différentes méthodes qui permettent au système de cache de fonctionner. </li>
                <li>css/js/json: comprend les fichiers permettant de modifier l'interface, ajouter des fonctions ou traiter des données JSON.</li>
                <li>tmp: contient les fichiers temporaires stockés grâce au système de cache. </li>
            </ul>